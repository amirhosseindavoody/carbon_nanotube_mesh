...
class btRigidBody  : public btCollisionObject
{
	...
	//boolean to determine if the object should be drawn or not
	bool drawable; //Added 4/30/15
...
public:
	...
	// TODO: Add throws exceptions and exception handling 

	virtual void setDrawable(bool draw)
	{
		drawable = draw;
	}
